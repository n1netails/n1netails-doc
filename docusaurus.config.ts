...
const config: Config = {
    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl:
            'https://github.com/n1netails/n1netails-doc/tree/main/packages/create-docusaurus/templates/shared/',
        },
        blog: {
  ...
  themeConfig: {
    ...
    footer: {
      ...
      copyright: `Copyright © ${new Date().getFullYear()} N1netales, Inc. Built with Docusaurus.`,
    },
    prism: {
